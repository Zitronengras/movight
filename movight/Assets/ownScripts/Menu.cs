...
public class Menu : MonoBehaviour {
	...
	void selectMenuTile(){
		...
		if (Physics.Raycast (Gestures.handControllerPos, Gestures.controlPoint, out hitObject, ConstructionDistance.maxWallDistance, onlyMenuLayer)) {
